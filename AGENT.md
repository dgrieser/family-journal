...
- `main` (Codex implementation, merged from the former `codex` branch)
- `gemini`
...
| `BRANCH_COMPARISON_REVIEW.md` | Detailed side-by-side comparison of every architectural layer (updated 2026-03-01) |
...
When updating any document in this branch, you **MUST** first switch to the respective branches `main` or `gemini` to retrieve the current state.
